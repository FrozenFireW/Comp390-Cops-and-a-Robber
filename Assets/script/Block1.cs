...
public class Block1 : MonoBehaviour
{
    ...
    {
        flag = 1;
        movement[1].x = transform.position.x + movement[1].x;
        movement[1].y = transform.position.y;
        movement[0].x = transform.position.x - movement[0].x;
        movement[0].y = transform.position.y;
    }
